			...
			<div class="row">
				...
				<div class="col-sm-4 pricing-box">
					...
					<div class="pricing-content general">
						<h2>Comprehensive Silver Full Body Checkup</h2>
						<h3>₹ 3300<sup></sup> <span>/ one time</span></h3>
						<ul>
				...
				<div class="col-sm-4 pricing-box featured-price">
					...
					<div class="pricing-content featured">
						...
						<h3>₹ 2000<sup></sup> <span>/ one time</span></h3>
						<ul>
							<li>Calcium <i class="fa fa-check icon-success"></i></li>
							<li>Erythrocyte Sedimentation Rate <i class="fa fa-check icon-success"></i></li>
							<li>Liver Function Test <i class="fa fa-check icon-success"></i></li>
							<li>Kidney Function Test with Electrolytes <i class="fa fa-check icon-success"></i></li>
				...
				<div class="col-sm-4 pricing-box">
					...
					<div class="pricing-content general last">
						<h2>Good Health Gold Package</h2>
						<h3>₹ 999<sup></sup> <span>/ one time</span></h3>
						<ul>
							<li>Anthropometry (BMI, WH Ratio) <i class="fa fa-check icon-success"></i></li>
							<li>Post Examination Review <i class="fa fa-check icon-success"></i></li>
