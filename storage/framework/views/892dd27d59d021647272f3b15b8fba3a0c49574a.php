...
<script>
    ...
    function getTextValue() {
        ...
        if (values != '') {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route('subtest.store')); ?>',
                data: "{'fields':'" + values + "', 'parent_test_name': '" + $('#parent_test_name').val() + "'}",
...
<?php /**PATH C:\xampp\htdocs\callabs\resources\views/admin/layouts/footer.blade.php ENDPATH**/ ?>