<section class="blog_w3ls py-lg-5">
            ...
            <div class="row py-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 med-blog">
                        <div class="card-header p-0">
                            <a href="single.html">
                                <img class="card-img-bottom" src="<?php echo e(asset('images/g5.jpg')); ?>" alt="Card image cap">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-5">
                    <div class="card border-0 med-blog">
                        <div class="card-header p-0">
                            <a href="single.html">
                                <img class="card-img-bottom" src="<?php echo e(asset('images/g2.jpg')); ?>" alt="Card image cap">
                            </a>
                        </div>
                        <div class="card-body border-0 px-0">
                            <div class="blog_w3icon">
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
                    <div class="card border-0 med-blog">
                        <div class="card-header p-0">
                            <a href="single.html">
                                <!-- <img class="card-img-bottom" src="<?php echo e(asset('images/g1.jpg')); ?>" alt="Card image cap"> -->
                            </a>
                        </div>
                        <div class="card-body border-0 px-0">
                            <div class="blog_w3icon">
    ...
    </section><?php /**PATH C:\xampp\htdocs\callabs\resources\views\layouts\blogs.blade.php ENDPATH**/ ?>